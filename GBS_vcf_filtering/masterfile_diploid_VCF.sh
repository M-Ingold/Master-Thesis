...
IN_QUAL=../../data/diploid_VCF/freebayes_269_samples_chr01-12_diploid.vcf
OUT_QUAL=../../data/diploid_VCF/freebayes_269_samples_chr01-12_diploid_QUAL_30.vcf

IN_SAMPLES=$OUT_QUAL
OUT_SAMPLES=../../data/diploid_VCF/freebayes_261_samples_chr01-12_diploid_QUAL_30.vcf

OUT_SNPs=../../data/diploid_VCF/freebayes_261_samples_chr01-12_diploid_QUAL_30_SNPs.vcf
OUT_MNPs=../../data/diploid_VCF/freebayes_261_samples_chr01-12_diploid_QUAL_30_MNPs.vcf
OUT_INDELs=../../data/diploid_VCF/freebayes_261_samples_chr01-12_diploid_QUAL_30_INDELs.vcf
OUT_COMPLEX=../../data/diploid_VCF/freebayes_261_samples_chr01-12_diploid_QUAL_30_COMPLEX.vcf

IN_BIAS=$OUT_SNPs
OUT_BIAS=../../data/diploid_VCF/freebayes_261_samples_chr01-12_diploid_QUAL_30_SNPs_1_read.vcf

IN_HET=$OUT_BIAS
OUT_HET=../../data/diploid_VCF/freebayes_261_samples_chr01-12_diploid_QUAL_30_SNPs_1_read_het.vcf

IN_BIALLEL=$OUT_HET
OUT_BIALLEL=../../data/diploid_VCF/freebayes_261_samples_chr01-12_diploid_QUAL_30_1_read_het_biallelic_SNPs.vcf

IN_MISSING=$OUT_BIALLEL
OUT_MISSING=../../data/diploid_VCF/freebayes_261_samples_chr01-12_diploid_QUAL_30_1_read_het_biallelic_SNPs_blanked.vcf

IN_DEPTH=$OUT_MISSING
OUT_DEPTH=../../data/diploid_VCF/freebayes_261_samples_chr01-12_diploid_QUAL_30_1_read_het_biallelic_SNPs_blanked_depth.vcf

IN_MAF=$OUT_DEPTH
OUT_MAF=../../data/diploid_VCF/freebayes_261_samples_chr01-12_diploid_QUAL_30_1_read_het_biallelic_SNPs_blanked_depth_MAF.vcf
