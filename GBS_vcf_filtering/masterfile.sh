...
IN_BIALLEL=$OUT_BIAS
OUT_BIALLEL=../../data/VCF/freebayes_261_samples_chr01-12_QUAL_30_1_read_biallelic_SNPs.vcf

IN_MISSING=$OUT_BIALLEL
OUT_MISSING=../../data/VCF/freebayes_261_samples_chr01-12_QUAL_30_1_read_biallelic_SNPs_blanked.vcf

IN_HET=$OUT_MISSING
OUT_HET=../../data/VCF/freebayes_261_samples_chr01-12_QUAL_30_SNPs_1_read_het_biallelic_SNPs_blanked.vcf

IN_DEPTH=$OUT_HET
OUT_DEPTH=../../data/VCF/freebayes_261_samples_chr01-12_QUAL_30_SNPs_1_read_het_biallelic_SNPs_blanked_depth.vcf

IN_MAF=$OUT_DEPTH
OUT_MAF=../../data/VCF/freebayes_261_samples_chr01-12_QUAL_30_SNPs_1_read_het_biallelic_SNPs_blanked_depth_MAF.vcf
...
# Min. 1 ALT and 1 REF alleles or 2 ALT and 0 REF alleles in the population at this site. Only counted if marked as called!
touch $OUT_HET
