...
IN_SAMPLES=$OUT_QUAL
OUT_SAMPLES=../../data/VCF/freebayes_264_samples_chr01-12_QUAL_30.vcf

IN_DEPTH=$OUT_SAMPLES
OUT_DEPTH=../../data/VCF/freebayes_264_samples_chr01-12_QUAL_30_depth.vcf

IN_BLANK=$OUT_DEPTH
OUT_BLANK=../../data/VCF/freebayes_264_samples_chr01-12_QUAL_30_depth_0.9_blanked.vcf

IN_BIAS=$OUT_BLANK
OUT_BIAS=../../data/VCF/freebayes_264_samples_chr01-12_QUAL_30_depth_0.9_blanked_1_read.vcf

IN_HET=$OUT_BIAS
OUT_HET=../../data/VCF/freebayes_264_samples_chr01-12_QUAL_30_depth_0.9_blanked_1_read_het.vcf

OUT_SNPs=../../data/VCF/freebayes_264_samples_chr01-12_QUAL_30_depth_0.9_blanked_1_read_het_SNPs.vcf
OUT_MNPs=../../data/VCF/freebayes_264_samples_chr01-12_QUAL_30_depth_0.9_blanked_1_read_het_MNPs.vcf
OUT_INDELs=../../data/VCF/freebayes_264_samples_chr01-12_QUAL_30_depth_0.9_blanked_1_read_het_INDELs.vcf
OUT_COMPLEX=../../data/VCF/freebayes_264_samples_chr01-12_QUAL_30_depth_0.9_blanked_1_read_het_COMPLEX.vcf

IN_BIALLEL=$OUT_SNPs
OUT_BIALLEL=../../data/VCF/freebayes_264_samples_chr01-12_QUAL_30_depth_0.9_blanked_1_read_het_biallelic_SNPs.vcf

IN_MISSING=$OUT_BIALLEL
OUT_MISSING=../../data/VCF/freebayes_264_samples_chr01-12_QUAL_30_depth_0.9_blanked_1_read_het_biallelic_SNPs_blanked.vcf

#QUAL >= 30
#sh filter_VCF_GWAS_QUAL.sh $IN_QUAL $OUT_QUAL

#filter out double genotypes: P2-AT, P2-LI, P1-AG, P01-BEL and bad coverage sample BIR-2. List created by hand
